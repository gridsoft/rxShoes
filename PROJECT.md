...
* **Immediate Next Steps:**
  1. [ ] Remaining homepage sections, in Figma order: Power Rotation tiers, Best Sellers grid, Educational comparison, Shop by Brand, Community Rotations — API pull if the rate limit has cleared, cached-screenshot pixel-sampling if not
  ...
  4. [ ] Real (non-screenshot-crop) category photos before launch — current ones bake in the Figma mockup's own badge text (see §13 dev log)
